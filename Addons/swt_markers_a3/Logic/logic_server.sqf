...
{
	params ["", "", "", "", "_owner", "_idstr"];
    swt_mrkIdStr = _idstr;
    _owner publicVariableClient "swt_mrkIdStr";
}];
...
//
swt_playersHash = [[], ""] call CBA_fnc_hashCreate;
private _connectedHandlerId = addMissionEventHandler ["PlayerConnected",
{
    params ["", "_uid", "", "", "", "_idstr"];
    [swt_playersHash, _idstr, _uid] call CBA_fnc_hashSet;
}];
